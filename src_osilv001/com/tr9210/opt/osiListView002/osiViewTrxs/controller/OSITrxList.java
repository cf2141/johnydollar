...
public class OSITrxList extends ScrollableContainer {
  ...
  public OSITrxList ( IControlContainer container, String name ) {
  ...
  public void actionPerformed(String actionId, String parameter) {
    log.debug("osiListView002.osiViewTrxs."+
              "controller.OSITrxList.actionPerformed "+actionId+" "+parameter);
    for (Iterator it=actionOrder.iterator(); it.hasNext();) {
      ((OSITrxItemAction)actionMap.get((String)it.next())).setEnabled(false);
    }
    ((OSITrxItemAction)actionMap.get(parameter)).setEnabled(true);
