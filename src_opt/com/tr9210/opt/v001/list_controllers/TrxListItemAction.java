...
public class TrxListItemAction implements IAction {
  ...
  public TrxListItemAction (String name) {
    title = name;
  }
  public TrxListItemAction (String name, Transaction t) {
    title = name;
    trx = t;
  }
	/**
	...
	//---------------------------------------------------------------------------
	public Transaction getTRX() { return trx; }
