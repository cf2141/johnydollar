...
public class OptHeaderTopRowAction implements IAction {
  ...
  public OptHeaderTopRowAction(String name, int sqlIndex) {
      ismName = name;
      ismIndex = sqlIndex;
  }
  ...
  public void run() {
    ...
    log.debug("com.tr9210.HeaderTopRowAction.run() ... "+ismName);
